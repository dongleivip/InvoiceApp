...
namespace InvoiceApi.Models
{
    ...
    public class DataEntity
    {
        ...
        // 排序键（可选）
        [DynamoDBRangeKey("SK")] public string SortKey { get; protected set; }
        ...
        // 实体类型标识
        [DynamoDBProperty("EntityType")] public string EntityType { get; protected set; }
        ...
        {
            return (Data != null && Data.ContainsKey(key)) ? Data[key].AsString() : string.Empty;
        }
    }
}